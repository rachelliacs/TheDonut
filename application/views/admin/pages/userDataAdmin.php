<div class="admin-list">
    ...
    <div id="edit-popup" class="popup-form">
        <form id="edit-form" method="post" action="<?= base_url(); ?>admin/userdataadmin/update">
    ...
    <div id="add-popup" class="popup-form">
        <form id="add-form" method="post" action="<?= base_url(); ?>admin/userdataadmin/add">
            <div class="form-content-wrap">
                <div class="card-header">
                    <h6>
                        Add New
